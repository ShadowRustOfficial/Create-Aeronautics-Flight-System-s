...
public final class FlightComputerConfig {
    ...
    static {
        ...
        THERMAL_SHUTDOWN_THRESHOLD = builder.comment("Temperature fraction of capacity at which operation shuts down.").defineInRange("thermalShutdownThreshold", 1.0D, 0.01D, 1.0D);
        builder.pop();
        SPEC = builder.build();
    }
